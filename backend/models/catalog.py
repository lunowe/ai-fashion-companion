...
# === ICON OVERRIDES ===
class IconOverrideMatch(BaseModel):
    fit: Optional[str] = None
    material: Optional[str] = None

class IconOverride(BaseModel):
    match: IconOverrideMatch = Field(default_factory=IconOverrideMatch)
    icon_id: str
...
class CatalogItemBase(BaseModel):
    ...
    icon_overrides: List[IconOverride] = Field(
        default_factory=list,
        description="Icon overrides for specific fit/material combinations"
    )
...
class CatalogItemUpdate(BaseModel):
    ...
    icon_overrides: Optional[List[IconOverride]] = None
