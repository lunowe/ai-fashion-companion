  ...
  return (
    <>
      ...
      <div className="px-4 pt-4 pb-2">
        <div className="flex items-center gap-1 sm:gap-2 p-1 bg-muted rounded-lg w-full sm:w-fit overflow-x-auto scrollbar-none">
          <button
            type="button"
            onClick={() => setMode("outfit")}
            className={`cursor-pointer flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 rounded-md text-xs sm:text-sm font-medium transition-all whitespace-nowrap flex-1 sm:flex-initial justify-center ${
              mode === "outfit"
          ...
          >
            ...
            <span className="hidden xs:inline">Create</span> Outfit
          </button>
          <button
            type="button"
          ...
          >
            ...
            <span className="hidden xs:inline">Pack for</span> Trip
          </button>
          <button
            type="button"
      ...
      {mode === "outfit" ? (
        ...
        <div className="px-4 pb-6">
          {!isPro ? (
            ...
            <div className="rounded-2xl border bg-gradient-to-b from-muted/50 to-transparent p-8 sm:p-12 text-center space-y-4 max-w-lg mx-auto">
              <div className="w-16 h-16 rounded-2xl bg-muted/80 flex items-center justify-center mx-auto">
                <Camera className="w-8 h-8 text-muted-foreground" />
              </div>
              <div className="space-y-2">
                <h3 className="font-semibold text-lg">Try a Piece</h3>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Snap a photo of any clothing item to instantly check if it fits
                  your wardrobe or get outfit ideas with your existing pieces.
                </p>
              </div>
              <Link to="/upgrade">
            ...
            <div
              className="bg-amber-500/10 border border-amber-500/20 text-amber-800 dark:text-amber-300 p-4 sm:p-5 rounded-xl"
              role="alert"
            >
              <p className="font-semibold text-sm">Daily Limit Reached</p>
              <p className="text-sm mt-1">
                You've used all {analysisLimit} item analyses for today. Come
                back tomorrow or{" "}
                <Link
                  to="/settings"
            ...
            <div className="space-y-6 sm:space-y-8 max-w-2xl mx-auto">
              ...
              {analysisLimit !== Infinity && (
                <p className="text-xs text-muted-foreground text-center">
                  {analysisCount}/{analysisLimit} analyses used today
                </p>
              )}
              ...
              <section className="space-y-3">
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground mt-1 ml-8">
                    Get a compatibility score, gap analysis, and buy recommendation
                  </p>
                </div>
              ...
              <section className="space-y-3">
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground mt-1 ml-8">
                    Get outfit ideas combining a new item with what you own
                  </p>
                </div>
                <div className="ml-0 sm:ml-8">
                  <StylePieceSection
