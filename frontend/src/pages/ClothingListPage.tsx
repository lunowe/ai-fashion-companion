...
import { listClothing, createClothing, deleteClothing, updateClothing } from "@/services/clothing";
...
export default function ClothingListPage() {
    ...
    const createMut = useMutation({
        ...
        onError: (e) => toast.error(`Fehler: ${e instanceof Error ? e.message : "Unbekannter Fehler"}`),
    });

    const updateMut = useMutation({
        mutationFn: (p: Partial<ClothingItem>) => updateClothing(editing!._id, p),
        onSuccess: () => {
